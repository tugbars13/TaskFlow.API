...
export default function CalloutBlock({ block, updateBlock, onKeyDown }) {
  return (
    <div className="flex items-start gap-3 my-3 p-4 bg-gray-50 rounded-lg border border-gray-100">
