...
const ACTIONS = [
  {
    ...
    label: "Create Task",
    icon: "add_task",
    color: "bg-primary/10 text-primary group-hover:bg-primary group-hover:text-on-primary",
  },
  {
    id: "schedule-meeting",
    label: "Schedule Sync",
    icon: "calendar_add_on",
    color: "bg-secondary/10 text-secondary group-hover:bg-secondary group-hover:text-on-secondary",
  },
  {
    id: "ai-summary",
    label: "AI Briefing",
    icon: "auto_awesome",
    color: "bg-tertiary-container/20 text-tertiary group-hover:bg-tertiary group-hover:text-on-tertiary",
  },
  {
    id: "invite-team",
    label: "Invite Member",
    icon: "person_add",
    color: "bg-surface-container-high text-on-surface group-hover:bg-on-surface group-hover:text-surface",
  },
];
    ...
    <Card className="apple-shadow p-lg rounded-2xl border border-outline-variant/10">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-md">
        {ACTIONS.map((action) => (
          ...
          >
            <div className={`w-10 h-10 rounded-xl flex items-center justify-center mb-xs transition-colors duration-200 ${action.color}`}>
