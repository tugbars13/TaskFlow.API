    ...
    >
      <div className="space-y-xl">
        ...
        <div className="flex items-center gap-sm px-xs">
          <div className="size-10 rounded-xl bg-primary text-white flex items-center justify-center font-bold text-md shadow-md">
            TF
          </div>
      ...
      <div className="p-md rounded-2xl bg-surface-container-low border border-outline-variant/10 flex items-center gap-md">
        <div className="size-8 rounded-full bg-secondary/20 text-secondary flex items-center justify-center font-semibold text-xs">
          WS
        </div>
